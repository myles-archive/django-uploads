...
setup(
	name = 'asgard-uploads',
	version = uploads.__version__,
	url = 'http://asgardproject.org/apps/uploads.html',
	
	author = 'Myles Braithwaite',
	author_email = 'me@mylesbraithwaite.com',
	
	description = 'A simple uploads application for the Asgard CMS system.',
